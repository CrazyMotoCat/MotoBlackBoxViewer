...
- partial logs пока поддерживаются ограниченно: часть каналов всё ещё считается обязательной
...
- GPS outlier filtering пока не реализован
- richer derived metrics ещё не доведены до полноценного анализа событий
